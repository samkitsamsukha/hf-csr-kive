        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-400 max-w-md">
              Empowering employees to make a difference through meaningful community engagement and social impact events.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <Link to="/dashboard" className="hover:text-primary-500 dark:hover:text-primary-400">
                    Dashboard
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-2">
                  <a href="#" className="hover:text-primary-500 dark:hover:text-primary-400">
                    Education
                  </a>
                </li>
                <li className="mb-2">
